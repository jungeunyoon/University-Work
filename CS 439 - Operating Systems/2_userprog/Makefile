...
turnin_threads: turnin.tar
	...
	@echo "         Your pair programming log is in the threads directory."
...
turnin_vm: turnin.tar
	...
	@echo "         Your pair programming log is in the vm directory."
	@echo "If either of those items are not done, please update your submission and run the make turnin command again."
...
turnin_fs: turnin.tar
	...
	@echo "         Your pair programming log is in the filesys directory."
	@echo "If either of those items are not done, please update your submission and run the make turnin command again."
